...
def initialize_components():
    ...
    try:
        ...
        required_vars = ['GEMINI_API_KEY', 'GOOGLE_APPLICATION_CREDENTIALS', 'GOOGLE_CLOUD_PROJECT']
...
async def root():
    ...
    return {
        ...
        "version": "2.0.0",
        "features": [
            "🎙️ Voice calls with real-time AI",
        ...
        "endpoints": {
            "voice_calls": "POST /webhook/voice",
            "sms_messages": "POST /webhook/sms",
            "voice_stream": "WS /voice/stream/{call_sid}",
